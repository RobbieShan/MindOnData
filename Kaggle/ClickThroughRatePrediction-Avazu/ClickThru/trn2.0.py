...
def importdata(a_projpath,a_trainfilename): 
    print "###############################In ImportData########################################"
    ...
    return vec.fit_transform(clickdata.values()).toarray()

#b = importdata(projpath,"trial.csv","train")
#print b
...
def main(): 
    ...
    traindata = importdata(projpath,trainfilename)
