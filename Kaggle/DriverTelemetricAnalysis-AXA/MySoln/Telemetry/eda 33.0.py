...
#            plt.title("Driver: AvgACosDel " + a_folder)
        ...
        drivers[a_folder][afile]['DStats']['NoOfTurns'] = np.array(masATanDel.count())
...
#        drivers[a_folder][afile]['DStats']['SDevATanDel'] = masATanDel.std() if masATanDel.count() != 0 else 0         
...
#        drivers[a_folder][afile]['DStats']['KurtATanDel'] = sp.stats.kurtosis(drivers[a_folder][afile]['ATanDel'][masATanDel!=True])   
...
#        drivers[a_folder][afile]['DStats']['SkewATanDel'] = sp.stats.skew(drivers[a_folder][afile]['ATanDel'][masATanDel!=True])   
...
#                                                ,'PC5'
    ...
    db = KMeans(n_clusters=10,n_jobs = -1).fit(Xpca)
...
#    probZMinDist = sp.stats.expon.pdf(zMinDist,scale=1/tef[1]) # Find the probability distribution this belongs to and get the probability
    probZMinDist = (1-sp.stats.norm.cdf(zMinDist)) # Find the probability distribution this belongs to and get the probability)
