...
#        print "File:" + afile
        ...
        plt.subplot(2,3,1)
        plt.plot(drivers[a_folder][afile]['DStats']['AvgDistDel'],drivers[a_folder][afile]['DStats']['TotalDist'],'b^')  
        plt.grid(True)
        plt.title("ADD*TD " + a_folder)
      
        plt.subplot(2,3,2)
        plt.plot(drivers[a_folder][afile]['DStats']['AvgDistDel'],drivers[a_folder][afile]['DStats']['AvgACosDel'],'b^')  
        plt.grid(True)
        plt.title("ADD*ACD " + a_folder)
                
        plt.subplot(2,3,3)
        plt.plot(drivers[a_folder][afile]['DStats']['SDevDistDel'],drivers[a_folder][afile]['DStats']['SDevACosDel'],'b^')  
        plt.grid(True)
        plt.title("SDD*SCD " + a_folder)

        plt.subplot(2,3,4)
        plt.plot(drivers[a_folder][afile]['DStats']['SDevDistDel'],drivers[a_folder][afile]['DStats']['TotalDist'],'b^')  
        plt.grid(True)
        plt.title("SDD*TD " + a_folder)
      
        plt.subplot(2,3,5)
        plt.plot(drivers[a_folder][afile]['DStats']['SDevACosDel'],drivers[a_folder][afile]['DStats']['TotalDist'],'b^')  
        plt.grid(True)
        plt.title("SCD*TD " + a_folder)
                
        plt.subplot(2,3,6)
        plt.plot(drivers[a_folder][afile]['DStats']['TotalTime'],drivers[a_folder][afile]['DStats']['TotalDist'],'b^')  
        plt.grid(True)
        plt.title("TM*TD " + a_folder)
