...
#            plt.plot( [x[0] for x in drivers[a_folder][afile]['Data'][len(drivers[a_folder][afile]['Data'])-1]], [x[1] for x in drivers[a_folder][afile]['Data'][len(drivers[a_folder][afile]['Data'])-1]])  
...
#    print drivers[a_folder]['DStats']                    
    drivers[a_folder]['DStats'] = drivers[a_folder]['DStats'].reshape(len(allfiles),9)
...
#    db = KMeans(n_clusters=5,n_jobs = -1).fit(Xpca)
